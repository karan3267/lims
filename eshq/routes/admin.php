...
Route::group(['prefix'=>'admin','as'=>'admin.','namespace'=>'Admin','middleware'=>['Admin','Branch']],function(){
    ...
    Route::get('/apps/calibration', 'AppController@calibration_index')->name('apps.calibration_index');
...
// ... other routes for viewing, editing, approving, etc.
    ...
    Route::put('/samples/{id}', 'SampleController@update')->name('samples.update');
    Route::delete('/samples/{id}', 'SampleController@destroy')->name('samples.destroy');
