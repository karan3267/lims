...
<html lang="en">
<head>
	<title>Prabhatech | @yield('title')</title>
	<meta charset="UTF-8">
...
<!--===============================================================================================-->
	...
	<meta name="msapplication-TileImage" content="{{url('img/logo2.png')}}">
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-more" style="background-image: url('{{url("img/logo2.png")}}'); background-size: 50%;">
				</div>
				...
				<div class="login100-form">
					...
					<span class="login100-form-title p-b-30">
						<img src="{{url('img/logo2.png')}}" height="100">
					</span>
