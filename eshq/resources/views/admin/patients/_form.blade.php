            ...
            <div class="col-lg-4">
                <div class="form-group">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="{{__('Vendor Name')}}" name="name" id="name" @if(isset($patient)) value="{{$patient->name}}" @elseif(old('name')) value="{{old('name')}}" @endif required>
                    </div>
                </div>
            </div>
